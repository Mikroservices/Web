...
const routes: Routes = [
    ...
    { path: 'stories', component: StoriesComponent, canActivate: [ AuthorizationGuardService ]  },
    { path: 'stories/new', component: StoryEditComponent, canActivate: [ AuthorizationGuardService ]  },
    { path: 'stories/:token', component: StoryDetailsComponent, canActivate: [ AuthorizationGuardService ]  },
    { path: 'stories/edit/:token', component: StoryEditComponent, canActivate: [ AuthorizationGuardService ]  },
